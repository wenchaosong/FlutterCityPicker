...
import '../src/cities_selector/cities_selector.dart';
import '../src/cities_selector/utils.dart';
import '../src/full_page/full_page.dart';
...
class CityPicker {
  ...
  static utils(
    ...
    return CityPickerUtil(
      provincesData: provinceData ?? CityPicker.metaProvinces,
      citiesData: citiesData ?? CityPicker.metaCities,
    );
  }
