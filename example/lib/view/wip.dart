...
class WorkInProgressState extends State<WorkInProgress> {
  ...
  toggle(BuildContext context) async {
    Result tempResult = await CityPicker.showCitiesSelector(
        context: context,
        title: title,
        locationCode: '110100',
        provincesData: !userSelfMeta ? CityPicker.metaProvinces : provincesData,
        citiesData: !userSelfMeta ? CityPicker.metaCities : citiesData,
        hotCities: [
